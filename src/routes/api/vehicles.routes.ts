...
import { getRecommendedServices } from '../../controllers/vehicles.controller/getRecommendedServices'
...
router.post(
  ...
  tokenGuard(),
  verifyToken(),
  schemaGuard(createVehiclesSchema),
  addVehicle
)
router.put(
  '/:licensePlate',
  tokenGuard(),
  verifyToken(),
  schemaGuard(updateVehiclesSchema),
  updateVehicle
)
